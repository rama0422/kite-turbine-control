...
class Kite:
    ...
    # def kiteDynamics(self, t, x, v_current_i, v_rel):
    #     p = x[0]
    #     pdot = x[1]
    ...
    #     F_tot_i = F_aero_i + F_mg_i + F_b_i # thether force unknown here
    ...
    #     self.data_log["Fs_grav"].append(F_mg_i)
    #     self.data_log["Fs_buoy"].append(F_b_i)
    #     self.data_log["Fs_net"].append(F_tot_i)
