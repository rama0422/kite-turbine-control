...
class Turbine:
    ...
    def turbineDynamics(self, t, x, v_rel, w_ref, log_bool=True):
        ...
        # TODO: want to clip T ref or not
        ...
        # electric torque dynamics https://www.sciencedirect.com/science/article/pii/S1364032115006814
        T_gen_el = T_cap(T_gen_el, w_gen, self.w_limit, self.w_gen_max_T, self.T_gen_max, self.m, self.b) 
        ...
        if log_bool:
            ...
            self.data_log["P_turb"].append(P_turb)
