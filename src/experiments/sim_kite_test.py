...
Fs_aero_i = np.array(kite.data_log["Fs_aero_i"])
Fs_grav_i = np.array(kite.data_log["Fs_grav_i"])
Fs_buoy_i = np.array(kite.data_log["Fs_buoy_i"])
Fs_tot_i = np.array(kite.data_log["Fs_tot_i"])
Fs_thether = np.array(kite.data_log["Fs_thether_abs"])
